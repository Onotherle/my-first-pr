...
4. Note the name of your repository `URL` here: **<https://github.com/Onotherle/my-first-pr>**
...
It does not provide a URL for pull because pulling is the same as a fetch and a merge. Pushing and fetching are the only controls available to remote repos.
